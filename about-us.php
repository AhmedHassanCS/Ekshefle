        ...
        <div class="row-fluid">
            <div class="span3">
                <div class="box">
                    ...
                    <a class="btn btn-facebook" href="#"><i class="icon-facebook"></i></a> <a class="btn  btn-google-plus" href="#"><i class="icon-google-plus"></i></a> <a class="btn  btn-twitter" href="#"><i class="icon-twitter"></i></a> <a class="btn  btn-linkedin" href="#"><i class="icon-linkedin"></i></a>
                </div>
            </div>
