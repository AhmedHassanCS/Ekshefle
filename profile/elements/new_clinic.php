        ...
        <div class="form-group" id="location">
          ...
          <table class="table" style="width:70%">
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" for="city" id="other_city_check" onchange="other_city_check();" disabled> أخري  
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" for="city" id="other_area_check" onchange="other_area_check();" disabled> أخري 
