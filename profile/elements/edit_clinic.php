...
<div class="box box-success" id="edit_clinic_div">
      ...
      <div class="box-body">
        ...
        <div class="form-group" >
          <h4>Specialty</h4>
            <select type="" id="specialty" disabled>
            <?php
              ...
              {
                if($spec["spec_id"]!=$med_info["spec_id"])
          ...
          <button class="btn btn-default" id="edit_spec" type="button" onclick="edit_spec();">Edit</button>
          <div class="input-group" id="spec_btns" hidden>
            <span id="specialty_error" style="color:red;"></span>
            <br>
            <button class="btn btn-success" id="save_spec" type="button" onclick="save_spec();" >Save</button>
        ...
        <div class="form-group" style="width:30%;">
          <h4>Days you are available in this clinic</h4>
          Edit days then click  &nbsp;&nbsp;<button class="btn btn-success" type="button" onclick="save_days();">Save</button>
          <?php 
        ...
        <div class="form-group">
          <h4> Price</h4>
          <input id="price" class="form-control" value=<?php echo '"'.$med_info["price"].'"';?> disabled>
          <button class="btn btn-default" id="edit_price" type="button" onclick="edit_price();" >Edit</button>
          <div class="input-group" id="price_btns" hidden>
            <span id="price_error" style="color:red;"></span>
            <br>
            <button class="btn btn-success" id="save_price" type="button" onclick="save_price();" >Save</button>
            <button class="btn btn-danger" id="cancel_price" type="button" onclick="cancel_price();" >Cancel</button>
          </div>
        </div><br>
        ...
        <div class="form-group">
          ...
          <input id="side_spec" class="form-control" value=<?php echo '"'.$med_info["side_spec"].'"';?> disabled >
          <button class="btn btn-default" id="edit_side" type="button" onclick="edit_side();" >Edit</button>
          <div class="input-group" id="side_btns" hidden>
            <span id="side_error" style="color:red;"></span>
            <br>
            <button class="btn btn-success" id="save_side" type="button" onclick="save_side();" >Save</button>
            <button class="btn btn-danger" id="cancel_side" type="button" onclick="cancel_side();" >Cancel</button>
          </div>
        </div><br>
      </div>
      ...
      <div class="box-footer">
        ...
        <button class="btn btn-danger btn-large" onclick="get_clinics();">Return To Clinics</button>
      </div>
